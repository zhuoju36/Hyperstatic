...
class Viewer():
    ...
    def show_result_deformation_X(self):
        self.show_result_deformation(dir="x")
    def show_result_deformation_Y(self):
        self.show_result_deformation(dir="y")
    def show_result_deformation_Z(self):
        self.show_result_deformation(dir="z")

    def show_result_deformation(self,casename="case1",dir="z"):
        scale=self.__scale
        api=self.__api
        pts=self.__pts.copy()
